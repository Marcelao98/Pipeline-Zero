...
Com isso, as duas metades da estrutura de controle estão completas: o programa já sabe decidir e sabe repetir. No próximo capítulo a gente vê **estrutura de dado**, ou seja, como guardar vários valores juntos e organizados, e finalmente a lista ganha o espaço que ela merece.
